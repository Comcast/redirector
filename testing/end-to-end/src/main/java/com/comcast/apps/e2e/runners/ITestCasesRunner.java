...
public interface ITestCasesRunner {

    Boolean performTestCases(RedirectorTestCaseList redirectorTestCaseList, String appName, FilesPathHelper filesPathHelper) throws Exception;
}
