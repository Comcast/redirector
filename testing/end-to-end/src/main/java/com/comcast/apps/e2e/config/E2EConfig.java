...
public interface E2EConfig {
    ...
    String getTestCasesRunner();

    List<String> getExtraTestsClasses();

    String getWebApplicationBasePort();

    String getWebApplicationBaseUrl();

    Long getDiscoveryPullInterval();
