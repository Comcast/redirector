...
public class DistributionTest extends DistributionBaseTest {
    ...
    String getDistributionFlavor() {
        return UxTestSuite.Constants.DISTRIBUTION_FLAVOR;
    }

    @Override
    String getDefaultFlavor() {
        return UxTestSuite.Constants.DEFAULT_FLAVOR2;
    }
}
