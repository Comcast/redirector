...
import static com.comcast.redirector.thucydides.tests.UxTestSuite.Constants.RULE_FLAVOR_3;

@RunWith(ThucydidesRunner.class)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class FlavorRulesTemplatesTest extends FlavorRulesTemplatesBaseTest {
