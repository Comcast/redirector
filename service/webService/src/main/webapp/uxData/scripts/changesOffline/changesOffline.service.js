...
(function () {
    ...
    angular
        ...
        .factory('changesOfflineService', changesOfflineService);

    changesOfflineService.$inject = ['$rootScope', '$q', 'requestsService', 'changesOfflineRequestsService', 'rulesBuilderService',
        'pathRulesBuilderService', 'urlRulesBuilderService', 'distributionRequestService'];

    function changesOfflineService($rootScope, $q, requestsService, changesRequestsService, ruleBuilderService,
        ...
        var service = {
            ...
            loadNamespacesChanges: loadNamespacesChanges
        };
        return service;
        ...
        function loadNamespacesChanges() {
            var defer = $q.defer();
            requestsService.getNamespacesChangesStatus($rootScope.currentApplication)
                .then(function (data) {
                    defer.resolve(data);
                }, function (reason) {
                    defer.reject(reason);
