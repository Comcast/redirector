                ...
                <ul class="nav navbar-nav navbar-right" ng-controller="applicationsCtrl as app">
                    ...
                    <li style="padding-top: 8px">
                        <ui-select
                            ...
                            <ui-select-match placeholder="Enter an application name..." ><span ng-bind="$select.selected"></span></ui-select-match>
...
<script src="../redirectorAdmin/config/app.config.js"></script>
...
<script src="../uxData/scripts/import/rules-import.service.js"></script>
...
<script src="../uxData/scripts/directives/ConvertNumber.js"></script>
...
<script src="../uxData/scripts/testsuite/testsuite-showauto.controller.js"></script>
...
<script src="../uxData/scripts/rules/rules-import.controller.js"></script>
...
<script src="../uxData/scripts/url-rules/url-rules-import.controller.js"></script>
...
<script src="../uxData/scripts/traffic/adjustedInputParam.controller.js"></script>
<script src="../uxData/scripts/traffic/adjustedInputParam.directive.js"></script>
