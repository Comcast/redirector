...
@ModelValidationVisitor(forClass = Equals.class)
public class EqualsExpressionValidationVisitor extends SingleParamExpressionValidationVisitor<Equals> {
    @Override
    public void visit(Equals item) {
        super.visit(item);
    }
}
