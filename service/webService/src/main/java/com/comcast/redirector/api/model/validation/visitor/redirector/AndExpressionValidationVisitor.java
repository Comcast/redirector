...
import com.comcast.redirector.api.model.AndExpression;
...
@ModelValidationVisitor(forClass = AndExpression.class)
public class AndExpressionValidationVisitor extends BaseExpressionValidationVisitor<AndExpression> {

    @Override
    public void visit(AndExpression item) {
