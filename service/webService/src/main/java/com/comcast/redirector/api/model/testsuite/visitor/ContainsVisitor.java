...
@TestSuiteVisitor(forClass = Contains.class)
public class ContainsVisitor extends ContainsBaseExpressionVisitor<Contains> {
    @Override
    protected List<Value> getValuesForNegation() {
        return Collections.singletonList(new Value("00:00:00:00:00:00:00"));
    }
}
