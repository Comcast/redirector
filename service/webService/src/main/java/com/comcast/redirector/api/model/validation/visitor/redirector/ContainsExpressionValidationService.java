...
@ModelValidationVisitor(forClass = Contains.class)
public class ContainsExpressionValidationService extends ContainsBaseExpressionValidationVisitor<Contains> {

    @Override
    public void visit(Contains item) {
        super.visit(item);
    }
}
