...
@Path(RedirectorConstants.TEMPLATES_URL_RULE_CONTROLLER_PATH)
public class TemplateUrlRulesController extends UrlRulesController {

    @Autowired
    public TemplateUrlRulesController(@Qualifier("templateUrlRulesService") IUrlRulesService urlRulesService, @Qualifier("urlParamsService") IUrlParamsService urlParamsService) {
