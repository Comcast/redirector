...
public class LessOrEqualExpressionMarshallingTest extends SelectServerTemplate {

    private static final String TEST_JSON_EXPRESSION = "\"lessOrEqual\":[{\"type\":\"lessOrEqual_type\",\"param\":\"lessOrEqual_param\",\"value\":\"lessOrEqual_value\"}]";
    private static final String TEST_XML_EXPRESSION = "<lessOrEqual type=\"lessOrEqual_type\"><param>lessOrEqual_param</param><value>lessOrEqual_value</value></lessOrEqual>";
    ...
    public static void setUp() {
        ...
        final LessOrEqualExpression testExpression = new LessOrEqualExpression();
        testExpression.type = "lessOrEqual_type";
        testExpression.setParam("lessOrEqual_param");
        testExpression.setValue("lessOrEqual_value");
    ...
    @Test
    public void testJsonToLessOrEqualObject() throws Exception {
    ...
    @Test
    public void testLessOrEqualObjectToJson() throws Exception {
    ...
    @Test
    public void testXmlToLessOrEqualObject() throws Exception {
    ...
    @Test
    public void testLessOrEqualObjectToXml() throws Exception {
