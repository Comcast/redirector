...
public class OrExpressionMarshallingTest extends SelectServerTemplate {
    ...
    private static final String TEST_JSON_EXPRESSION = "\"or\":[{" + TEST_JSON_OR_PARAM_EXP_1 + "," + TEST_JSON_OR_PARAM_EXP_2 + "}]";
    private static final String TEST_XML_EXPRESSION = "<or>" + TEST_XML_OR_PARAM_EXP_1 + TEST_XML_OR_PARAM_EXP_2 + "</or>";
    ...
    public static void setUp() {
        ...
        final OrExpression testExpression = new OrExpression();
    ...
    @Test
    public void testJsonToOrObject() throws Exception {
    ...
    @Test
    public void testOrObjectToJson() throws Exception {
    ...
    @Test
    public void testXmlToOrObject() throws Exception {
    ...
    @Test
    public void testOrObjectToXml() throws Exception {
