...
public class InIpRangeExpressionMarshallingTest extends SelectServerTemplate {

    private static final String TEST_JSON_EXPRESSION = "\"inIpRange\":[{\"negation\":false,\"type\":\"inIpRange_type\",\"param\":\"inIpRange_param\",\"values\":{\"value\":[\"inIpRange_value1\",\"inIpRange_value2\"]},\"namespacedList\":{\"value\":[\"namespacedList_1\",\"namespacedList_2\"]}}]";
    private static final String TEST_XML_EXPRESSION = "<inIpRange negation=\"false\" type=\"inIpRange_type\"><param>inIpRange_param</param><values><value>inIpRange_value1</value><value>inIpRange_value2</value></values><namespacedList><value>namespacedList_1</value><value>namespacedList_2</value></namespacedList></inIpRange>";
    ...
    public static void setUp() {
        ...
        final InIpRange testExpression = new InIpRange();
        testExpression.type = "inIpRange_type";
        testExpression.setParam("inIpRange_param");
        testExpression.setValues(new ArrayList<Value>() {{
            add(new Value("inIpRange_value1"));
            add(new Value("inIpRange_value2"));
        }});
