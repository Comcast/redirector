...
public class EqualsExpressionMarshallingTest extends SelectServerTemplate {

    private static final String TEST_JSON_EXPRESSION = "\"equals\":[{\"param\":\"equals_param\",\"value\":\"equals_value\"}]";
    private static final String TEST_XML_EXPRESSION = "<equals><param>equals_param</param><value>equals_value</value></equals>";
    ...
    public static void setUp() {
        ...
        final Equals testExpression = new Equals();
        testExpression.setParam("equals_param");
        testExpression.setValue("equals_value");
    ...
    @Test
    public void testJsonToEqualsObject() throws Exception {
    ...
    @Test
    public void testEqualsObjectToJson() throws Exception {
    ...
    @Test
    public void testXmlToEqualsObject() throws Exception {
    ...
    @Test
    public void testEqualsObjectToXml() throws Exception {
