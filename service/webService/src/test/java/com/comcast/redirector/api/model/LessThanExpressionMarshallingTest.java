...
public class LessThanExpressionMarshallingTest extends SelectServerTemplate {

    private static final String TEST_JSON_EXPRESSION = "\"lessThan\":[{\"type\":\"lessThan_type\",\"param\":\"lessThan_param\",\"value\":\"lessThan_value\"}]";
    private static final String TEST_XML_EXPRESSION = "<lessThan type=\"lessThan_type\"><param>lessThan_param</param><value>lessThan_value</value></lessThan>";
    ...
    public static void setUp() {
        ...
        final LessThan testExpression = new LessThan();
        testExpression.type = "lessThan_type";
        testExpression.setParam("lessThan_param");
        testExpression.setValue("lessThan_value");
    ...
    @Test
    public void testJsonToLessThanObject() throws Exception {
    ...
    @Test
    public void testLessThanObjectToJson() throws Exception {
    ...
    @Test
    public void testXmlToLessThanObject() throws Exception {
    ...
    @Test
    public void testLessThanObjectToXml() throws Exception {
