...
public class NotEqualExpressionMarshallingTest extends SelectServerTemplate {

    private static final String TEST_JSON_EXPRESSION = "\"notEqual\":[{\"param\":\"notEqual_param\",\"value\":\"notEqual_value\"}]";
    private static final String TEST_XML_EXPRESSION = "<notEqual><param>notEqual_param</param><value>notEqual_value</value></notEqual>";
    ...
    public static void setUp() {
        ...
        final NotEqual testExpression = new NotEqual();
        testExpression.setParam("notEqual_param");
        testExpression.setValue("notEqual_value");
    ...
    @Test
    public void testJsonToNotEqualObject() throws Exception {
    ...
    @Test
    public void testNotEqualObjectToJson() throws Exception {
    ...
    @Test
    public void testXmlToNotEqualObject() throws Exception {
    ...
    @Test
    public void testNotEqualObjectToXml() throws Exception {
