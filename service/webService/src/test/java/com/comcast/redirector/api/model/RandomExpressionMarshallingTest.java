...
public class RandomExpressionMarshallingTest extends SelectServerTemplate {

    private static final String TEST_JSON_EXPRESSION = "\"random\":[{\"value\":\"random_value\"}]";
    private static final String TEST_XML_EXPRESSION = "<random><value>random_value</value></random>";
    ...
    public static void setUp() {
        ...
        final Random testExpression = new Random();
        testExpression.setValue("random_value");
    ...
    @Test
    public void testJsonToRandomObject() throws Exception {
    ...
    @Test
    public void testRandomObjectToJson() throws Exception {
    ...
    @Test
    public void testXmlToRandomObject() throws Exception {
    ...
    @Test
    public void testRandomObjectToXml() throws Exception {
