...
package com.comcast.redirector.endpoint.http.context;

import com.comcast.redirector.RedirectorGateway;
import com.comcast.redirector.endpoint.http.services.HttpRedirectorService;
...
public class HttpEndpointContext {
    ...
    public RedirectorService redirectorService() {
        return new HttpRedirectorService(RedirectorGateway.getInstance());
    }
}
