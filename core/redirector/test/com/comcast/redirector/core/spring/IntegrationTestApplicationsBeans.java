...
public class IntegrationTestApplicationsBeans {
    @Inject
    ...
    public IApplicationsManager applicationsManager() {
        return new ApplicationsManager(commonBeans.config().getAppsRetrievingIntervalInSeconds(), commonBeans.config().getBackupBasePath());
    }
}
