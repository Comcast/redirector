...
public interface IDataChangePoller {
    
    void startDataChangePolling(String entityName, String url, int interval,
    ...
    void suspendPolling(String appName);
    
    void restartPollingIfSuspended(String appName);
}
