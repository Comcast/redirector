...
public interface IDataStoreAwareNamespacedListsHolder extends NamespacedListRepository {
    void load(boolean fromDataStore);

    void createBackupNamespacedLists();

    NamespacedListsBatch getNamespacedListsBatch();

    boolean isNamespacedListsOutOfDate();
}
