...
@XmlSeeAlso({AndExpression.class, OrExpression.class, Equals.class, NotEqual.class, GreaterOrEqualExpression.class, GreaterThan.class, LessOrEqualExpression.class, LessThan.class, Contains.class, Random.class, Server.class, ServerGroup.class, IsEmpty.class})
@XmlAccessorType(XmlAccessType.FIELD)
public class AndExpression extends VisitableExpression implements Serializable, HasChildren {
