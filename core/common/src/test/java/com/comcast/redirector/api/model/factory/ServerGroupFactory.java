...
public class ServerGroupFactory {
    ...
    public static ServerGroup newServerGroup(final List<Server> servers, final String enablePrivate,
            final String countDownTime) {

        final ServerGroup serverGroup = new ServerGroup();
        serverGroup.setServers(servers);
        serverGroup.setEnablePrivate(enablePrivate);
        serverGroup.setCountDownTime(countDownTime);
